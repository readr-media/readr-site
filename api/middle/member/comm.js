...
const sendInitializingSuccessEmail = ({ email, }) => {
  return new Promise(resolve => {
    sendEmail({
      ...
      <p>那麼，新聞的內容只能由傳統編輯台來決定嗎？如果讓讀者同時參與新聞產製，會發生什麼事？若在新聞產製時就敞開大門，讓同樣身懷各種專長的讀者一起參與，題目會不會更有可看性？「開放編輯室」能不能不再只是口號？</p>
      <p>去年，我們做了政治獻金的報導。在台灣，選舉時政治獻金的明細只以紙本形式被典藏在監察院，根本沒有應用的價值。團隊便在手工數位化之後、正式撰寫報導之前，就將資料在網路上公開，讓各方人馬可以運用這份資料，嘗試更多的應用。</p>
      <p>當時，除了媒體之外，也有許多資料科學家、鄉民，看到了我們忽略的角度，做出有趣的成果。倘若能真正的「開放」，新聞的產品就不再只會有最終的報導，還能從過程中長出更多的應用、或在這份基礎上繼續茁壯。</p>
      <p>在這個沒有人能壟斷資訊的時代，新聞媒體該扮演什麼樣的角色？又該提供什麼樣的資訊給讀者？READr 是我們為了解答問題而進行的實驗。每個人都有自己的資訊來源跟同溫層，READr 想做的不是取代，而是補充，再更進一步將這些互動帶進編輯室裡。</p>
      <p>我們每週會邀請活躍於不同領域的客座總編，跟讀者分享他們最近關心的事。讀者對這些議題的關切程度也將成為編輯室選題的重要指標。背後的計算不會只是瀏覽次數這麼簡單，還包括新聞事件背後的議題、事件與事件的關聯性等等。例如我們會看到農地違建的新聞，也有一些人關心山上的非法民宿，看起來雖然都像是獨立事件，但它們都指向了國土計畫這個重大議題。</p>
      <p>因此，讀者的討論與互動會影響接下來進行專題的方向。議題形成後，記者會不定時公布報導進行的進度，也會在不影響報導的原則下，公布取得的資料及素材。而參與開放編輯室的讀者可以隨時參與討論，記者會評估讀者提供的方向或資料，進行調查。在專題發布完成之後，開放編輯室的內容與討論也會完全公開。</p>
      <p>信任是媒體存在的前提，現在卻成為我們努力追回的目標。當這個時代各種資訊真假難辨，我們希望透過更開放的報導製程，嘗試尋回讀者的信任。這個社群或許有機會擺脫點閱率迷思，凝聚更多關心議題的使用者，對新聞供需兩方都會產生正向的循環。公開透明在新聞編輯室能做到多大的程度？透明與參與會是找回信任的方法嗎？如果你也在乎這些問題，我們想邀請你一起來尋找答案。</p>
